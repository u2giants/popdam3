...
const MG02_DESC_TO_CODE: Record<string, Record<string, string>> = {
  ...
  N: {
    ...
    "chest": "C",
    "basket (floor)": "K",
    "basket (carrying)": "H", // "basket (carrying)" maps to H (hamper) per schema proximity
    "tower/stand": "T",
    "cube-collapsible": "U",
  },
  P: {
    ...
    "chest": "C",
    "jewelry/music box": "J",
    "jewellery/music box": "J", // spelling variant
    "lift-off": "F",
    "kitchen": "K",
    "ottoman non-collapsible": "N",
  },
  R: { "tray/dish": "T" },
...
const MG03_DESC_TO_CODE: Record<string, Record<string, string>> = {
  "A:A": {
    ...
    "staggered": "G",
    "hi-gloss": "H",
    "glitter/sequins/rhinest": "Q",
    "handpaint": "P",
    "physical attachment": "Y",
    "gel/other coat": "W",
    "gel coat": "W",
  },
  ...
  "B:G": {
    ...
    "led backlit": "E",
    "printed": "F",
    "printed flat": "F", // "printed flat" treated as "printed"
    "sbox w glit/foil": "Q",
    "sbox w attachment": "R",
    "glass sandwich": "W",
    "sbox printed": "X",
  ...
  "U:P": { "none": "0" },
  "V:D": {
    "coir w/ plain print": "C",
    "coir w/ emboss": "D",
    "coir diecut": "E",
    "rubber w/ plain print": "R",
    "tpe w/ print": "U",
    "rubber w/ embossed": "Q",
    "tpe w/ diecut": "T",
  },
