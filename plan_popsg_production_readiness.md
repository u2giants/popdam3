...
| 8. Build comprehensive PopSG search and filters | 🟨 in progress | Shared-db #2506 is closed and its v2 objects are reported in production, but a natural default Files call still hits SQLSTATE 57014 at the normal ceiling. Successor #2860 is waiting for re-admission by the next active shared-db orchestrator after markers #2858 and #2893 closed; app cutover/final QA remain pending |
