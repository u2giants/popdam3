...
| 3. Make crawl completion truthful and restart-safe | 🟨 in progress | Governed contract plus app orchestration deployed; bridge v1.16.11 / `6ca879e7`; Edge `agent-api` v15 from `24013e55`; the first two post-contract ordinary runs safely stopped with zero deactivations after exposing a missing accepted-count stamp, now repaired; first clean ordinary-run proof pending |
