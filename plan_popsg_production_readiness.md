...
| 3. Make crawl completion truthful and restart-safe | 🟨 in progress | Lifecycle/drop-guard helpers, restart run reuse, additive old/new response handling, 18 focused tests, and fail-safe bridge deployment; bridge v1.16.11 / `6ca879e7` is production-stable; 30-run guard evidence in `verification/popsg-readiness/crawl-guard-baseline-2026-09-03.json`; dependent RPC orchestration and forced-failure integration pending shared-db #2212 |
