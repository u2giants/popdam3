...
| 7. Finish searchable PDF/source coverage | 🟨 in progress | Serialized Windows release `0.16.3.159` is live; the single PopDAM backlog is landing durable rows and fell from 23,549 to 23,499 in its first repaired batches; PopSG remains gated on PopDAM completion and shared-db #2507 |
