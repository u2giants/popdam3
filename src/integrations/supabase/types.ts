  ...
  public: {
    Tables: {
      ...
      smon_ai_analyses: {
        ...
        Relationships: [
          {
            foreignKeyName: "smon_ai_analyses_nas_id_fkey"
            columns: ["nas_id"]
            isOneToOne: false
      ...
      smon_alerts: {
        ...
        Relationships: [
          {
            foreignKeyName: "smon_alerts_nas_id_fkey"
            columns: ["nas_id"]
            isOneToOne: false
            referencedRelation: "smon_nas_units"
            referencedColumns: ["id"]
      ...
      smon_container_status: {
        ...
        Relationships: [
          {
            foreignKeyName: "smon_container_status_nas_id_fkey"
            columns: ["nas_id"]
            isOneToOne: false
            referencedRelation: "smon_nas_units"
            referencedColumns: ["id"]
      ...
      smon_container_status_p20260329: {
        Row: {
          container_id: string
          container_name: string
          cpu_percent: number | null
      ...
      smon_container_status_p20260405: {
        Row: {
          container_id: string
          container_name: string
          cpu_percent: number | null
      ...
      smon_container_status_p20260412: {
        Row: {
          container_id: string
          container_name: string
          cpu_percent: number | null
      ...
      smon_copilot_actions: {
        ...
        Relationships: [
          {
            foreignKeyName: "smon_copilot_actions_assistant_message_id_fkey"
            columns: ["assistant_message_id"]
            isOneToOne: false
            referencedRelation: "smon_copilot_messages"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "smon_copilot_actions_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "smon_copilot_sessions"
            referencedColumns: ["id"]
          },
        ]
      }
      smon_copilot_messages: {
        Row: {
          content: string
          created_at: string
          evidence: Json
        ...
        Relationships: [
          {
            foreignKeyName: "smon_copilot_messages_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "smon_copilot_sessions"
            referencedColumns: ["id"]
      ...
      smon_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "smon_logs_nas_id_fkey"
            columns: ["nas_id"]
            isOneToOne: false
            referencedRelation: "smon_nas_units"
            referencedColumns: ["id"]
      ...
      smon_metrics: {
        ...
        Relationships: [
          {
            foreignKeyName: "smon_metrics_nas_id_fkey"
            columns: ["nas_id"]
            isOneToOne: false
            referencedRelation: "smon_nas_units"
            referencedColumns: ["id"]
      ...
      smon_security_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "smon_security_events_nas_id_fkey"
            columns: ["nas_id"]
            isOneToOne: false
            referencedRelation: "smon_nas_units"
            referencedColumns: ["id"]
      ...
      smon_storage_snapshots: {
        ...
        Relationships: [
          {
            foreignKeyName: "smon_storage_snapshots_nas_id_fkey"
            columns: ["nas_id"]
            isOneToOne: false
            referencedRelation: "smon_nas_units"
            referencedColumns: ["id"]
      ...
      smon_storage_snapshots_default: {
        Row: {
          disks: Json
          id: string
          nas_id: string
      ...
      smon_storage_snapshots_p20260329: {
        Row: {
          disks: Json
          id: string
          nas_id: string
      ...
      smon_storage_snapshots_p20260405: {
        Row: {
          disks: Json
          id: string
          nas_id: string
      ...
      smon_storage_snapshots_p20260412: {
        Row: {
          disks: Json
          id: string
          nas_id: string
