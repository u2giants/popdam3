          ...
          <TooltipTrigger asChild>
            {isRunning ? (
              ...
              <Button
                ...
                disabled={op.status === "running" || selectedGroups.length === 0}
                title={selectedGroups.length === 0 ? "Select groups to AI tag" : op.status === "running" ? "AI tagging in progress..." : "AI tag selected groups"}
              >
