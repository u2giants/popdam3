          ...
          <TooltipTrigger asChild>
            {isRunning ? (
              ...
              <Button
                ...
                disabled={op.isRunning || selectedGroups.length === 0}
                title={selectedGroups.length === 0 ? "Select groups to AI tag" : op.isRunning ? "AI tagging in progress..." : "AI tag selected groups"}
              >
