...
| 4. Build the Style Group profile pass | 🟨 in progress | 2026-08-26 | Deterministic representative selection landed at `bbc2a6e8`: primary-first, thumbnail-only, file/view diversity, near-duplicate suppression without `quick_hash`, 4–8 cap, and bounded payload; 73 worker tests and worker build passed. Next connect the group-profile handler, atomic RPC writer, durable operation state, and admin/conflict registration. |
